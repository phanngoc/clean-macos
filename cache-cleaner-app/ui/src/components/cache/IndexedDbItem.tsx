  ...
  return (
    <div
      className={`group flex items-center gap-4 p-4 rounded-xl border-2 transition-all duration-300 cursor-pointer ${
        isSelected 
          ? 'bg-gradient-to-r from-[oklch(0.6_0.2_290)]/5 to-[oklch(0.6_0.2_290)]/10 border-[oklch(0.6_0.2_290)]/40 shadow-lg shadow-[oklch(0.6_0.2_290)]/10 scale-[1.01]' 
    ...
    >
      ...
      <div className={`relative flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-300 ${
        isSelected 
          ? 'bg-gradient-to-br from-[oklch(0.6_0.2_290)] to-[oklch(0.55_0.18_310)] shadow-md' 
      ...
      {/* Icon */}
      <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[oklch(0.6_0.2_290)]/10 to-[oklch(0.6_0.2_290)]/20">
        {isExtension ? (
          <Database className={`h-5 w-5 transition-colors ${
            isSelected ? 'text-[oklch(0.6_0.2_290)]' : 'text-muted-foreground group-hover:text-foreground'
          }`} />
        ) : (
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          {isExtension && (
            <span className="px-2 py-0.5 rounded-md bg-[oklch(0.6_0.2_260)]/10 text-[oklch(0.6_0.2_260)] font-medium">
              Extension
            </span>
          )}
        </div>
      ...
      <div className={`shrink-0 px-3 py-1.5 rounded-lg font-mono text-sm font-bold transition-all duration-300 ${
        isSelected 
          ? 'bg-gradient-to-r from-[oklch(0.6_0.2_290)] to-[oklch(0.55_0.18_310)] text-white shadow-md' 
          : item.over_threshold
            ? 'bg-[oklch(0.6_0.2_290)]/10 text-[oklch(0.6_0.2_290)] group-hover:bg-[oklch(0.6_0.2_290)]/15'
